...
[![Fork on GitHub](https://img.shields.io/badge/Fork_on_GitHub-blue?logo=github)](https://github.com/deepgram-starters/deno-live-transcription/fork)
...
```bash
git clone --recurse-submodules https://github.com/deepgram-starters/deno-live-transcription.git
