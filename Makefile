# Deno Live Transcription Makefile
# Framework-agnostic commands for managing the project and git submodules

.PHONY: help check check-prereqs init install install-frontend build start start-backend start-frontend clean status update eject-frontend

# Default target: show help
help:
	@echo "Deno Live Transcription - Available Commands"
	@echo "========================================"
	@echo ""
	@echo "Setup:"
